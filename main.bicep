...
var resourceNames = {
  ...
  keyVaultName: 'kv-cps-ipam-dev-uksouth-001'
...
module privateEndpoint 'br/public:avm/res/network/private-endpoint:0.7.0' = {
  ...
  params: {
    ...
    subnetResourceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.Network/virtualNetworks/VNET/subnets/SUBNETNAME'
    ...
    privateDnsZoneGroup: {
      privateDnsZoneGroupConfigs: [
        {
          privateDnsZoneResourceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.Network/privateDnsZones/privatelink.vaultcore.azure.net'
        }
      ]
    }
    privateLinkServiceConnections: [
      {
        ...
        properties: {
          ...
          privateLinkServiceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.KeyVault/vaults/KEYVAULTNAME'
        }
      }
    ]
    tags: {
...
module privateEndpointcosmos 'br/public:avm/res/network/private-endpoint:0.7.0' = {
  ...
  params: {
    // Required parameters
    name: 'ipam-cosmos'
    subnetResourceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.Network/virtualNetworks/VIRTUALNETWORK/subnets/SUBNETNAME'
    location: location
    privateLinkServiceConnections: [
      {
        ...
        properties: {
          ...
          privateLinkServiceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUPNAME/providers/Microsoft.DocumentDB/databaseAccounts/COSMOS-DB-NAME'
        }
      }
    ]
  }
...
module appService './modules/appService.bicep' = if (!deployAsFunc) {
  ...
  params: {
    ...
    Subnetid: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.Network/virtualNetworks/VIRTUALNETWORK/subnets/SUBNETNAME'
  }
}
    ...
    privateLinkServiceConnections: [
      {
        ...
        properties: {
          ...
          privateLinkServiceId: '/subscriptions/SUBSCRIPTION/resourceGroups/RESOURCEGROUP/providers/Microsoft.Web/sites/APPSERVICE'
        }
      }
    ]
  }
